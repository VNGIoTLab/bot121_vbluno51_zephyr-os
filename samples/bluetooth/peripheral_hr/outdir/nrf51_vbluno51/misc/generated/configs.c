...
GEN_ABSOLUTE_SYM(CONFIG_BOARD_NRF51_PCA10028, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_UART_NRF5_GPIO_TX_PIN, 9);
...
GEN_ABSOLUTE_SYM(CONFIG_BLUETOOTH_ATT_PREPARE_COUNT, 0);
...
GEN_ABSOLUTE_SYM(CONFIG_UART_NRF5_GPIO_CTS_PIN, 10);
...
GEN_ABSOLUTE_SYM(CONFIG_UART_NRF5_GPIO_RTS_PIN, 8);
