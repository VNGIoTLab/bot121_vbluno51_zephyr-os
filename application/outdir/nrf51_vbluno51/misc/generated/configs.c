...
GEN_ABSOLUTE_SYM(CONFIG_BLUETOOTH_MAX_PAIRED, 0);
...
GEN_ABSOLUTE_SYM(CONFIG_BLUETOOTH_L2CAP_TX_MTU, 23);
...
GEN_ABSOLUTE_SYM(CONFIG_BLUETOOTH_DEVICE_APPEARANCE, 6000);
